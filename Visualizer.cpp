...
main (int argc, char *argv[])
{
  ...
  /* Char array to select the visualisation element */
  char *element_to_be_used[] = {"Synaescope", "GOOM", "Monoscope", "Stereo visualizer"};
  ...
  for (walk = list; walk != NULL; walk = g_list_next (walk)) {
    ...
    if (selected_factory == NULL || g_str_has_prefix (name, element_to_be_used[3])) {
